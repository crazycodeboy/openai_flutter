...
import 'interfaces/ai_create.dart';

class AICompletion implements AICreateInterface {
  /// Creates a new completion and returns a [AIResponse] object.
  ///
  ///
  ...
  Future<AIResponse> create(
    ...
    return await AIHttp.post<AIResponse>(
      to: AIConfigBuilder.instance.completionsUrl,
      body: {
        "model": model,
